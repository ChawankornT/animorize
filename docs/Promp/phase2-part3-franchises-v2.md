...
- `deleteFranchiseAction` ต้อง catch FK constraint error (franchise มี media อยู่) → return `{ success: false, message: 'Cannot delete: this franchise has media entries' }`
