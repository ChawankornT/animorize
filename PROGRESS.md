...
- **In progress:** Phase 5 — UX Polish — **P0 pre-phase docs ✅** (merged to `develop`, PR #29, 2026-08-26); full spec = 16 decisions in `DECISIONS.md` §P5; **P1 impl prompt hardened to v2 + design bundle re-synced (2026-08-27)** — P2 design addendum delivered, no blockers left; next up: implement P1 (DS chore), see Phase 5 Progress below
...
| P1   | DS chore — `Popover` component ใหม่ · `Modal` → native `<dialog>` (rescoped — verify/gap-fill only, not full conversion) · shared `ToastPortal` (ยุบ 3 duplicate) + BRAND/DECISIONS/CLAUDE.md doc-sync | ready — impl prompt finalized v2 (2026-08-27) — not started    |
